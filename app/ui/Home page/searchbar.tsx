	...
	return (
		<form className={`flex ${width} ${height}`}>
			<input
				placeholder="Search..."
				type="text"
				className="w-full h-full border-solid border-[1px] rounded-2xl py-2 px-3 border-slate-300 active:border-black"
			/>
			<button className="-translate-x-[200%] relative" type="submit">
