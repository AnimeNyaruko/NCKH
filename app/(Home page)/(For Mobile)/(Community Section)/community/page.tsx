...
export default function Page() {
	...
	return (
		<main className="w-full h-[200vh]">
			<header className="sticky top-0 w-full h-[10dvh]">
			...
			<Link
				href={`${path}/chatgpt`}
				className="sticky float-right top-[97.5vh] mr-5 w-[15%] select-none">
			...
			<Link
				href={`${path}/add`}
				className="sticky float-left top-[97.5vh] ml-5 w-[15%] h-fit select-none">
				<div id="chatbot" className="w-full aspect-square bg-blue-400 rounded-full">
