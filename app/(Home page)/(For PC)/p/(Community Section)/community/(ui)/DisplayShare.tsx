		...
		<>
			...
			{show && (
				<div className="z-[9] fixed top-0 right-0 left-0 w-screen h-screen bg-black/75 backdrop-blur-sm flex justify-center items-center">
					<div className="z-10 relative w-1/2 h-1/4 bg-white rounded-2xl flex justify-center items-center gap-x-5">
						<FontAwesomeIcon
							onClick={() => {
								setShow(false);
							}}
						...
						<div
							...
							id="Download"
							className="h-[32.5%] flex justify-center items-center text-white text-3xl aspect-square rounded-full bg-blue-500">
